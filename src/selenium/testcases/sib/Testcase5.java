...
public class Testcase5 {
	...
	public void invokeBrowser() {
		try {
			System.setProperty("webdriver.chrome.driver", "C:\\Users\\jephi\\Desktop\\Software testing tools\\chromedriver_win32\\chromedriver.exe");	
	...
	public void NearestBranch() {
		try {
			...
			driver.findElement(By.id("cphMainContent_htxtSearch")).sendKeys("bathery");
